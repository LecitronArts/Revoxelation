...
// MeshletPool has been extracted to meshlet_pool.rs (Phase 5 cleanup).
// Re-export for backward compatibility.
pub use super::meshlet_pool::{
    GpuMeshlet, MeshletPool, MeshletRange,
    INITIAL_MESHLET_CAPACITY, INITIAL_MESHLET_VERTEX_CAPACITY, INITIAL_MESHLET_TRI_CAPACITY,
};
